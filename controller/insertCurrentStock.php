...
if (isset($_POST['insertCurrentStock'])) {
    addToDB("CurrentStock",$_POST['Type'], $_POST['FullName'],$_POST['CatalogNumber'],$_POST['Description'],
    $_POST['Quantity'],$_POST['Units'], $_POST['ExpiryDate'], $_POST['MaintenanceFrequency']);
}
?>